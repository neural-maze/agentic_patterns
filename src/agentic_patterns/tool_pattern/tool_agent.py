...
class ToolAgent:
    ...
    def run(
        ...
        tool_chat_history: List = [
            build_prompt_structure(prompt=TOOL_SYSTEM_PROMPT % self.add_tool_signatures(),
                                   role="system"),
            user_prompt
        ]
        ...
        tool_call_str = self.client.chat.completions.create(
